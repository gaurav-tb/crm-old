...
//echo "SELECT employee.name, contact.fname, contact.lname, contact.mobile, product.name, servicecall.fromdate, servicecall.todate, contact.id,servicecall.id FROM employee,contact,servicecall,product WHERE contact.ownerid = employee.id AND product.id = servicecall.product and servicecall.cid = contact.id AND servicecall.approved = '1' AND servicecall.delete='0'";
$getData = mysql_query("SELECT employee.name, contact.fname, contact.lname, contact.mobile, product.name, servicecall.fromdate, servicecall.todate, contact.id,servicecall.id FROM employee,contact,servicecall,product WHERE contact.ownerid = employee.id AND product.id = servicecall.product and servicecall.cid = contact.id AND servicecall.approved = '1' AND servicecall.delete='0'",$con) or die(mysql_error());
?>
