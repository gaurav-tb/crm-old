...
WHERE  `expensereport`.`UploadingDate` BETWEEN  '$initialmon' AND '$finalmon'  AND `contact`.`ownerid`='$loggeduserid' GROUP BY expensereport.Clientid
...
Month Target Report<span style="text-transform:capitalize"><?php echo $_GET['name'];?></span></td>
</td>
</tr>
</table>
</div>
...
<?php 
 ...
 ?>	
<tr><td><b>Total</b></td><td colspan="5"></td><td><?php  ?></td></tr>
</table>
</div>
</div>
