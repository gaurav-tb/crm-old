...
<!--<option value="3" <?php //if($row['accountopening'] == 3) { echo 'selected';} ?>>Discount Coupon</option>-->
		...
		<td >
		<select class="input" name="req" style="width:130px" onchange="Checkpaymethod(this.value)" id="optt13">
		<option value="" >Please select </option>
		...
		<td>
		<input name="req" class="input" style="width:200px" type="text" onblur="chkOrderID()" id="optt11" value="<?php echo $row['accountopeningreffno'];?>" />
		...
		<td>
		<input name="req" class="input" style="width:200px" type="text"  id="optt12" value="<?php echo $row['pancardnumber'];?>" />
		...
		<?php } else { ?>
		<input name="Button2" id="optt15" type="button" value="Click to convert" class="buttonGreen"  onclick="clicktoconvert('<?php echo $cid;?>','14');" />&nbsp;&nbsp;	
		<?php } ?>
		</td>
		</tr>	
	    </table>
