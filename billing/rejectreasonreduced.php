...
<div class=form>
	<table width="100%" cellpadding="0" cellspacing="10">
		...
		<tr>
			...
			<td>
				<input name="Button2" type="button" value="Click to reject" class="buttonGreen" onclick="SaveData('billing/savereducedreject?researchid=<?php echo $researchid ?>&cid=<?php echo $cid;?>','opt','1','','','','2');document.getElementById('viewmoodleContent').innerHTML='';document.getElementById('manipulatemoodleContent').innerHTML='';ToggleBox('bigMoodle','none','')" />&nbsp;&nbsp;
			</td>
		</tr>	
	</table>
</div>
