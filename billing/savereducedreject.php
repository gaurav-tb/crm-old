...
$note = "Reduced Brokerage activation request has been rejected by <strong>".$loggedname."</strong>,With Reason ".$post[0];
...
mysql_query("DELETE FROM `reduced_brokerage` WHERE `id`='$researchid'",$con) or die(mysql_error());
