...
$getCity = mysql_query("SELECT `name` FROM `city` WHERE `id` = '$rowComp[3]'",$con) or die(mysql_error());
$rowCity = mysql_fetch_array($getCity);
$getState = mysql_query("SELECT `name` FROM `state` WHERE `id` = '$rowComp[4]'",$con) or die(mysql_error());
