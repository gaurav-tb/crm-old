...
$sql = "SELECT employee.name, employee.mobile, employee.email, profile.name, employee.status, employee.modifieddate,employee.id FROM employee,profile WHERE  employee.profile = profile.id AND employee.delete = '0' ORDER BY ".$sortby." ".$sorttype." LIMIT 100";
}
else
{
$sql = "SELECT employee.name, employee.mobile, employee.email, profile.name, employee.status, employee.modifieddate,employee.id FROM employee,profile WHERE  employee.profile = profile.id AND employee.delete = '0' ORDER BY employee.name LIMIT 100";
}
