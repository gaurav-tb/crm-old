...
$id = $_GET['id'];
$getData = mysql_query("SELECT * FROM `zone` WHERE `id` = '$id'",$con) or die(mysql_error());
...
<tr>
<td align="right" style="height: 36px">Zone Name<span style="color:maroon">*</span></td>
...
<?php if(in_array('U_zone',$thisPer))
			{
			?>
<input name="Button1" type="button" value="Update" class="buttonGreen" onclick="SaveData('masters/zone/update?id=<?php echo $id;?>&i=<?php echo $_GET['i'];?>','opt','2','<?php echo $_GET['i'];?>','','','2')" />&nbsp;&nbsp;<?php } ?>
