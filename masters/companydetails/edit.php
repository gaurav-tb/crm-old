...
<tr>
	...
	<td>
	<input class="input" style="width:200px" name="req" id="opt0" type="text" value="<?php echo $row['name'] ?>"/>
	</td>
	<td>
...
<tr>
	...
	<td>
			<input id="opt1" class="input" type="text" name="req" style="width:200px" value="<?php echo $row['adr1']?>">
&nbsp;</td>
	<td>
	Address Line 2
	</td>
...
<select name="req" id="opt4" class="input"  style="width: 200px" id="opt13">
...
?>
	...
	<td>
	<select name="req" id="opt5" class="input"  style="width: 200px" > 
		<?php
	...
	<td>
<select name="req" id="opt6" class="input"  style="width: 200px" > 
		<?php
	...
	<td>
	<input class="input" name="req" id="opt7" type="text" value="<?php echo $row['pincode']?>" />
	</td>
	...
	<td>
	<input class="input" name="req" id="opt8" type="text" value="<?php echo $row['pan'] ?>" />
	</td>
</tr>
<tr>
