...
<tr>
<td align="right">Template<span style="color:maroon">*</span></td>
<td align="left"><textarea style="height:50px;width:300px" cols="20" id="opt1" name="req" rows="2"><?php echo $row['template'];?></textarea>
</td>
</tr>
<tr>
<td align="right">
