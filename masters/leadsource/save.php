...
mysql_query("INSERT INTO `leadsource` (`name`, `description`, `createdate`, `modifieddate`, `updatedby`, `id`, `delete`,`disp`) VALUES ('$post[0]', '$post[1]', '$datetime', '$datetime', '$loggeduserid', '', '0','$post[2]')",$con) or die(mysql_error());
$id = mysql_insert_id();
...
<td class="blueSimpletext" style="width:300px;" onclick="getModule('masters/leadsource/edit?id=<?php echo $id;?>&i=PUTGENERATEDIHERE','manipulateContent','viewContent','Fetching Data..')"><?php echo $newRow[0];?></td>
