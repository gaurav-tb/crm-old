...
?>
		...
		<td class="blueSimpletext" onclick="getModule('masters/product/edit?id=<?php echo $newRow[9];?>&amp;i=PUTGENERATEDIHERE','manipulateContent','viewContent','Fetching Data..')" style="width: 300px;">
