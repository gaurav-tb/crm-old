...
?>
	<td style="width: 20px;">
		...
		<td class="blueSimpletext" onclick="getModule('masters/product/edit?id=<?php echo $newRow[9];?>&amp;i=<?php echo $i;?>','manipulateContent','viewContent','Fetching Data..')" style="width: 300px;">
