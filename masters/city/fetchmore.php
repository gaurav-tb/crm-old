...
<td class="blueSimpletext" style="width:300px;" onclick="getModule('masters/city/edit?id=<?php echo $row[3];?>&i=<?php echo $i;?>','manipulateContent','viewContent','Fetching Data..')"><?php echo $row[0];?></td>
