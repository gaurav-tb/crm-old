...
Upload Pay In -Pay Out Report
</td>

<td align="right">
<a href="masters/upload/payin.csv" style="text-decoration:none" class="buttonGreen" >Click Here To Download Sample</a>
</td>
...
<form method="post" action="masters/upload/savePayinPayOut.php" target="targetFrame" enctype="multipart/form-data">
