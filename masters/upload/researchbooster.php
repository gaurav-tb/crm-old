...
Research Booster Upload
</td>

<td align="right">
<a href="masters/upload/ResearchSample.csv" style="text-decoration:none" class="buttonGreen" >Click Here To Download Sample</a>
</td>
...
<form method="post" action="masters/upload/saveresearchbooster.php" target="targetFrame" enctype="multipart/form-data">
