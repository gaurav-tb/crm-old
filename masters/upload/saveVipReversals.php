...
{ 
	...
	while(!feof($rfile)){
		...
		$result=mysql_query("INSERT INTO `payinpayoutlogs` (`id`,`code`,`TradeDate`,`Debit`,`Credit`,`UploadingDate`,`VoucherNumber`,`ChequeNumber`) VALUES ('','$code','$Tradedate','$Debit','$Credit','$thisdate','$VoucherNumber','$ChequeNumber')",$con) or die(mysql_error());
		}
