...
$id = $_GET['id'];
$getData = mysql_query("SELECT * FROM `faqcategories` WHERE `id` = '$id'",$con) or die(mysql_error());
...
<tr>
<td align="right" style="height: 36px">Add New FAQ Category<span style="color:maroon">*</span></td>
	<td align="left" style="height: 36px"><input class="input" name="req" type="text" id="opt0" value="<?php echo $row['categoriesName'];?>" /></td>
</tr>
...
<input name="Button1" type="button" value="Update" class="buttonGreen" onclick="SaveData('masters/faqcategory/update?id=<?php echo $id;?>&i=<?php echo $_GET['i'];?>','opt','4','<?php echo $_GET['i'];?>','','','2')" />&nbsp;&nbsp;<?php } ?>
