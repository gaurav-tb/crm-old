...
<td class="blueSimpletext" style="width:300px;" onclick="getModule('masters/category/edit?id=<?php echo $id;?>&i=PUTGENERATEDIHERE','manipulateContent','viewContent','Fetching Data..')"><?php echo $newRow[0];?></td>
