...
$id = $_GET['id'];
$getData = mysql_query("SELECT * FROM `category` WHERE `id` = '$id'",$con) or die(mysql_error());
...
{
?>
<input name="Button1" type="button" value="< Back To List" class="button" onclick="getModule('masters/category/view','viewContent','manipulateContent','Service Category')" />
<?php
}
...
<tr>
<td align="right" style="height: 36px">Service Category Name<span style="color:maroon">*</span></td>
...
<td></td>
<td>
<?php  if(in_array('U_service',$thisPer))
			{
			?>
<input name="Button1" type="button" value="Update" class="buttonGreen" onclick="SaveData('masters/category/update?id=<?php echo $id;?>&i=<?php echo $_GET['i'];?>','opt','2','<?php echo $_GET['i'];?>','','','2')" />&nbsp;&nbsp;<?php } ?>
