...
<tr>
<td align="right">State Name<span style="color:maroon">*</span></td><td align="left">
...
<select name="select1" id="opt1" class="input" style="width: 300px">
		<?php
		$getData = mysql_query("SELECT `id`,`name` FROM `country` WHERE `delete`='0' AND `id` != '1' ORDER BY `name` ",$con) or die(mysql_error());
...
<td></td>
<td>
<input name="Button2" type="button" value="Save & New" class="buttonGreen" onclick="SaveData('masters/state/save','opt','2','','','','1')" />&nbsp;&nbsp;
<input name="Button1" type="button" value="Save & Back" class="buttonGreen" onclick="SaveData('masters/state/save','opt','2','','','','1');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')" />&nbsp;&nbsp;
