...
$id = $_GET['id'];
$getData = mysql_query("SELECT * FROM `leadresponse` WHERE `id` = '$id'",$con) or die(mysql_error());
...
<tr>
<td align="right" style="height: 36px">Lead Response Name<span style="color:maroon">*</span></td>
...
<input name="Button1" type="button" value="Update" class="buttonGreen" onclick="SaveData('masters/leadresponse/update?id=<?php echo $id;?>&i=<?php echo $_GET['i'];?>','opt','4','<?php echo $_GET['i'];?>','','','2')" />&nbsp;&nbsp;<?php } ?>
