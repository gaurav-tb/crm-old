...
mysql_query("INSERT INTO `leadresponse` (`name`, `description`, `createdate`, `modifieddate`, `updatedby`, `id`, `delete`,`order`,`display`) VALUES ('$post[0]', '$post[1]', '$datetime', '$datetime', '$loggeduserid', '', '0','$post[2]','$post[3]')",$con) or die(mysql_error());
$id = mysql_insert_id();
