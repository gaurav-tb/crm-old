...
$getData = mysql_query("SELECT introducer.name,introducer.modifieddate,employee.name,introducer.id FROM introducer,employee WHERE introducer.updatedby = employee.id AND introducer.delete = '0' AND introducer.id != '1' AND introducer.name LIKE '$term%' ORDER BY introducer.name",$con) or die(mysql_error());
...
?>
	...
	<tr id="fetchRow<?php echo $i;?>">
		...
		<td class="blueSimpletext" onclick="getModule('masters/introducer/edit?id=<?php echo $row[3];?>&i=<?php echo $i;?>&type=search','manipulateContent','viewContent','Fetching Data..')" style="width: 300px;">
		<?php echo $row[0];?>
		</td>
...
<div class="moduleFoot">
		...
		<span onclick="getModule('masters/introducer/view','viewContent','manipulateContent','Countries')" style="cursor: pointer">
