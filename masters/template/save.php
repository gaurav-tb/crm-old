...
?>
	<td style="width: 20px;">
		...
		<td class="blueSimpletext" onclick="getModule('masters/template/edit?id=<?php echo $row[3];?>&amp;i=PUTGENERATEDIHERE','manipulateContent','viewContent','Fetching Data..')" style="width: 300px;">
		<?php echo $row[0];?></td>
