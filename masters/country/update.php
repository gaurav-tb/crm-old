...
mysql_query("UPDATE `country` SET `name` = '$post[0]',`modifieddate` = '$datetime', `updatedby`  = '$loggeduserid' WHERE `id` = '$id'",$con);
...
<td class="blueSimpletext" style="width:300px;" onclick="getModule('masters/country/edit?id=<?php echo $id;?>&i=<?php echo $i;?>','manipulateContent','viewContent','Fetching Data..')">
