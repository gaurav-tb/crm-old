	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			CallbackDate : <input class="input" style="width:200px" type="date" id="ntl2" name="req1" value="0">
			 &nbsp;&nbsp;
			 Callbacktime : <input class="input" style="width:200px" type="time"  id="ntl3" name="req2"  placeholder="HH:MM:PM">
<br/>
...
<br/>
<textarea name="req" onchange="updateLiveDesc();SaveData('noteline/save?cid=<?php echo $cid;?>&name=<?php echo $_GET['name'];?>','ntl','4','','','','3');" cols="20" rows="2" style="width:98%;height:100px;" class="input"  id="ntl1"></textarea>
