...
$getData = mysql_query("SELECT cannottalkto.id,employee.name,cannottalkto.desc,cannottalkto.modifieddate FROM cannottalkto,employee WHERE cannottalkto.userid= employee.id AND cannottalkto.delete = '0' AND employee.name LIKE '%$term%' ORDER BY cannottalkto.id DESC",$con) or die(mysql_error());
?>
