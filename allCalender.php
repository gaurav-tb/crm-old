		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<img src="images/previous.png"/> </td>
...
<select id="selMonth" onchange="updateFromSel();" class="input" style="width:50px;background:#fff;color:#222;border:0px;">
		...
		<tr>
			...
			<img src="images/close-notif-hover.png" onclick="document.getElementById('CALENDAR').style.visibility='hidden';" style="cursor:pointer" />
			</div>
			 </td>
		</tr>
	</table>
