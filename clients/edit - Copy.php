...
?>
<?php if(in_array('A_AS_Clients',$thisPer) || $loggeduserid == 1 || $loggeduserid == $row[0]){
?>
...
<tr>
	...
	<input name="Text1" style="margin-left:-40px;" type="text" class="inputDisabled" value="<?php echo $plan ?>" readonly="readonly" />
...
<tr>
	...
	{
	?>
	<td align="left" style=""><input class="input"  style="width: 200px" name="req" maxlength="10" type="text" id="opt5" value="<?php echo $row['mobile']; //substr($row['mobile'], 0, 0) . 'XXXXXXX' . substr($row['mobile'],  -3);?>" />  &nbsp;&nbsp;   <a class="blueSimpletext clickto" href="callto:<?php echo $row['mobile']; ?>">Click to call</a>  </td>
	   </td>
	<?php } 
	else
	{
	?>
	<td align="left" style=""><input class="input"  style="width: 200px" name="req" maxlength="10" type="text" id="opt5" value="<?php echo $row['mobile']; //substr($row['mobile'], 0, 0) . 'XXXXXXX' . substr($row['mobile'],  -3);?>" readonly="readonly" />   &nbsp;&nbsp;  <a class="blueSimpletext clickto" href="callto:<?php echo $row['mobile']; ?>">Click to call</a>   </td>
	<?php
	}
	?>
...
<tr>
<td align="right">BO Mobile </td>
<td style="">
<input class="input"  style="width: 200px"  readonly type="text" id="opt7" value="<?php echo $row['phone']; //substr($row['phone'], 0, 0) . 'XXXXXXX' . substr($row['phone'],  -3);?>" /></td>
...
<td align="left"><input class="input"  style="width: 200px" readonly  type="text" id="opt8" value="<?php echo $row['altemail']?>" /></td>
	...
	<tr>
        ...
        <td style="">
        <input class="input" style="width:200px" type="text" id="opt34" value="<?php echo $rowUid['AlternativeMobile'];?>" />
        </td> 
...
<div class="moduleHeading">
		<table  width="100%" cellpadding="0" cellspacing="0">
			...
			<!-- <tr height="50px"><td colspan='8' align="center"><b>Target Calculation</b></td></tr>
				<tr height="30px"><th><?php // echo  date("d M, Y",$AllotedDate) ." To ".date("d M, Y",$FirstMonth) ?></th><th><?php // echo date("d M, Y",$FirstMonth+86400) ." To ".date("d M, Y",$SecondMonth) ?></th><th><?php // echo date("d M, Y",$SecondMonth+86400) ." To ".date("d M, Y",$ThirdMonth) ?></th><th colspan='2'><?php // echo date("d M, Y",$ThirdMonth+86400) ." Onwords " ?></th></tr>
                <tr height="20px"><td><?php // if($rowDate[0]==''){   echo '100%';  } else { echo '25%'; } ?></td><td><?php // if($rowDate[0]==''){ echo '100%';  }  else { echo '50%'; } ?></td><td><?php // if($rowDate[0]==''){ echo '100%';  }  else { echo '75%'; } ?></td><td colspan='2'><?php // echo '100%'  ?></td></tr>               
		...
		<!--	<tr>
				...
				<!--</td>
					...
					<!-- </td>
						...
						<td>
						<input name="Checkbox1" type="checkbox" id="<?php echo 'opt'.$h;?>" value="1" <?php if($row['welcomemail'] == 1) { echo "checked disabled"; }?> />
						<?php $h++;?>
						</td>
						</tr>
