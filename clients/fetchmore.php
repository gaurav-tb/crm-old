...
?>
		...
		<img src="images/hot.png" id="hot<?php echo $row['id'];?>" style="height:12px" alt=""  onclick="getModule('leads/markHot?id=<?php echo $row['id'];?>&todo=cold','','hot<?php echo $row[4];?>','');document.getElementById('cold<?php echo $row['id'];?>').style.display='';"/> 
		<img src="images/cold.png" id="cold<?php echo $row['id'];?>" style="height:12px;display:none" alt="" onclick="getModule('leads/markHot?id=<?php echo $row['id'];?>&todo=hot','','cold<?php echo $row[4];?>','');document.getElementById('hot<?php echo $row['id'];?>').style.display='';"/>  
	...
	<!-- 	<td style="width:100px"><?php // echo $turnover; ?></td><!-- revenue Generation -->
		...
		?>
		<td style="width:100px"><?php echo ucfirst(strtolower($rowName[0]));?></td>
 
		<td>
<img onclick="SupportLevel('<?php echo $row[8] ;?>')"  src="images/story.png" style="width:15px" title="Story For <?php echo $row[0];?>" alt=""/>
