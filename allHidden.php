...
<div class="bigMoodle" id="loading" style="padding-top:200px;z-index:20000000000000000000">
<div style="position:fixed;right:0px;cursor:pointer;background:#b82121;padding:5px;color:#fff" onclick="ToggleBox('loading','none');enableAllButtons();">Stop</div>
...
<div class="close" id="ModalCloseButton" style="z-index:1000"  onclick="document.getElementById('viewmoodleContent').innerHTML='';document.getElementById('manipulatemoodleContent').innerHTML='';ToggleBox('bigMoodle','none','')"></div>
