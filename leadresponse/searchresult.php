...
?>
	<tr id="fetchRow<?php echo $i;?>">
		...
		<td onclick="getModule('masters/leadresponse/edit?id=<?php echo $row[3];?>&i=<?php echo $i;?>&type=search','manipulateContent','viewContent','Fetching Data..')" style="width: 300px;">
		<?php echo $row[0];?></td>
