...
<div  class="form" style="width:100%;height:600px;">
...
<tr>
	...
	<?php 
		$p=0;
	$getProduct = mysql_query("SELECT product.name FROM servicecall,product WHERE servicecall.type = 'f' AND servicecall.product = product.id AND servicecall.cid = '$id'",$con) or die(mysql_error()); 
