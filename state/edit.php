...
<td><?php
			...
			{
			?>
<input name="Button1" type="button" value="Update" class="button" onclick="SaveData('masters/state/update?id=<?php echo $id;?>&i=<?php echo $_GET['i'];?>','opt','2','<?php echo $_GET['i'];?>','','','2')" />&nbsp;&nbsp;<?php } ?>
