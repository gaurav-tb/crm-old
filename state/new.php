...
<td></td>
<td>
<input name="Button2" type="button" value="Save & New" class="button" onclick="SaveData('masters/state/save','opt','2','','','','1')" />&nbsp;&nbsp;
<input name="Button1" type="button" value="Save & Back" class="button" onclick="SaveData('masters/state/save','opt','2','','','','1');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')" />&nbsp;&nbsp;
