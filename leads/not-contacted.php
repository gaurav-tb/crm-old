...
$sortby = $_GET['sortby'];
	...
	{
	$sortstr = " ORDER BY leadresponse.name ".$sortby." LIMIT 100";
	}
	else
	{
...
{
	//$sql = "SELECT employee.name, contact.fname, contact.mobile, contact.callbackdate,contact.id,leadresponse.name,contact.modifieddate,contact.mark,contact.read,contact.lname,contact.description,contact.product,contact.leadstatus,contact.createdate,contact.callbacktime,leadsource.name FROM contact,employee,leadresponse,leadsource WHERE contact.leadsource = '30' AND contact.leadstatus = '3' AND contact.ownerid = employee.id AND contact.delete = '0' AND contact.converted= '0' AND contact.latestresponse = leadresponse.id".$leadstr." " .$intLeadsStr." ".$transLeadsStr." ".$ftLeadsStr." ".$sortstr;
$sql = "SELECT employee.name, contact.fname, contact.mobile, contact.callbackdate,contact.id,leadresponse.name,contact.modifieddate,contact.mark,contact.read,contact.lname,contact.description,contact.product,contact.leadstatus,contact.createdate,contact.callbacktime,leadsource.name FROM contact,employee,leadresponse,leadsource WHERE contact.leadsource = '30' AND contact.leadstatus = '3' AND contact.ownerid = employee.id AND `contact`.`leadsource`=`leadsource`.`id` AND contact.delete = '0' AND contact.converted= '0' AND contact.latestresponse = leadresponse.id".$leadstr." " .$intLeadsStr." ".$transLeadsStr." ".$ftLeadsStr." ".$sortstr;
$getData = mysql_query($sql,$con) or die(mysql_error());
}
else
{
$sql = "SELECT employee.name, contact.fname, contact.mobile, contact.callbackdate,contact.id,leadresponse.name,contact.modifieddate,contact.mark,contact.read,contact.lname,contact.description,contact.product,contact.leadstatus,contact.createdate,contact.callbacktime,leadsource.name FROM contact,employee,leadresponse,leadsource WHERE  contact.leadsource = '30' AND contact.leadstatus = '3' AND contact.ownerid = employee.id AND contact.delete = '0' AND contact.converted= '0' AND contact.latestresponse = leadresponse.id AND `contact`.`leadsource`=`leadsource`.`id` AND contact.ownerid = '$loggeduserid'".$leadstr." " .$intLeadsStr." ".$transLeadsStr." ".$ftLeadsStr." ".$sortstr;
//echo $sql;
$getData = mysql_query($sql,$con) or die(mysql_error());
}	
}
...
if(in_array('VA_leads',$thisPer))
{
$sql = "SELECT employee.name, contact.fname, contact.mobile, contact.callbackdate,contact.id,leadresponse.name,contact.modifieddate,contact.mark,contact.read,contact.lname,contact.description,contact.product,contact.leadstatus,contact.createdate,contact.callbacktime,leadsource.name FROM contact,employee,leadresponse WHERE contact.ownerid = employee.id AND contact.delete = '0' AND contact.converted= '0' AND contact.latestresponse = leadresponse.id".$leadstr." " .$intLeadsStr." ".$transLeadsStr." ".$ftLeadsStr." ".$sortstr;
$getData = mysql_query($sql,$con) or die(mysql_error());
}
else
{
$sql = "SELECT employee.name, contact.fname, contact.mobile, contact.callbackdate,contact.id,leadresponse.name,contact.modifieddate,contact.mark,contact.read,contact.lname,contact.description,contact.product,contact.leadstatus,contact.createdate,contact.callbacktime,leadsource.name FROM contact,employee,leadresponse WHERE contact.ownerid = employee.id AND contact.delete = '0' AND contact.converted= '0' AND contact.latestresponse = leadresponse.id AND contact.ownerid = '$loggeduserid'".$leadstr." " .$intLeadsStr." ".$transLeadsStr." ".$ftLeadsStr." ".$sortstr;
$getData = mysql_query($sql,$con) or die(mysql_error());
}	
}
//echo $sql;
