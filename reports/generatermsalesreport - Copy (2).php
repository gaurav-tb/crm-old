...
$day=date("D",strtotime($fromdate));
   ...
   if($day=="Mon")
   {
      $initialWeek1 = date("Y-m-d", strtotime("+0 day",strtotime($fromdate))); 
         $finalWeek1 = date("Y-m-d", strtotime("+6 day",strtotime($fromdate)));  
...
if($day=="Tue")
{
   $initialWeek1 = date("Y-m-d", strtotime("-1 day",strtotime($fromdate))); 
      $finalWeek1 = date("Y-m-d", strtotime("+5 day",strtotime($fromdate)));  
...
if($day=="Wed")
{
   $initialWeek1 = date("Y-m-d", strtotime("-2 day",strtotime($fromdate))); 
      $finalWeek1 = date("Y-m-d", strtotime("+4 day",strtotime($fromdate)));  
...
if($day=="Thu")
{
   $initialWeek1 = date("Y-m-d", strtotime("-3 day",strtotime($fromdate))); 
      $finalWeek1 = date("Y-m-d", strtotime("+3 day",strtotime($fromdate)));  
...
if($day=="Fri")
{
   $initialWeek1 = date("Y-m-d", strtotime("-4 day",strtotime($fromdate))); 
      $finalWeek1 = date("Y-m-d", strtotime("+2 day",strtotime($fromdate)));  
...
if($day=="Sat")
{
   $initialWeek1 = date("Y-m-d", strtotime("-5 day",strtotime($fromdate))); 
      $finalWeek1 = date("Y-m-d", strtotime("+1 day",strtotime($fromdate)));  
...
if($day=="Sun")
{
   $initialWeek1 = date("Y-m-d", strtotime("-6 day",strtotime($fromdate))); 
      $finalWeek1 = date("Y-m-d", strtotime("+0 day",strtotime($fromdate)));  
...
$name ="Relation Manager Sales Summary Report_".$format.".xls"; 
