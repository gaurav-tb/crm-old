...
$getLAlloted = mysql_query("SELECT contact.id FROM contact,employee WHERE contact.alloted = '1' AND contact.self = '0' AND contact.ownerid = employee.id  AND ".$owstr." AND  contact.createdate BETWEEN '$fromdate' AND '$todate'",$con) or die(mysql_error()); 
...
$getCalls=mysql_query("SELECT noteline.id FROM noteline,contact,employee WHERE noteline.subject ='Call' AND noteline.cid = contact.id AND ".$owstr." AND contact.ownerid = employee.id  AND  contact.createdate BETWEEN '$fromdate' AND '$todate'",$con) or die(mysql_error());
$count3 = mysql_num_rows($getCalls);
$getMeetings=mysql_query("SELECT noteline.id FROM noteline,contact,employee WHERE noteline.subject ='Meeting' AND noteline.cid = contact.id AND ".$owstr." AND contact.ownerid = employee.id  AND  contact.createdate BETWEEN '$fromdate' AND '$todate'",$con) or die(mysql_error());
$count4 = mysql_num_rows($getMeetings);
$getFreetrial = mysql_query("SELECT servicecall.id FROM servicecall,employee,contact WHERE servicecall.type = 'f' AND servicecall.cid = contact.id  AND ".$owstr." AND contact.ownerid = employee.id  AND  contact.createdate BETWEEN '$fromdate' AND '$todate' ",$con) or die(mysql_error());
$count5 = mysql_num_rows($getFreetrial);
$getFtGiven = mysql_query("SELECT servicecall.id FROM servicecall,employee,contact WHERE  servicecall.type = 'f' AND servicecall.approved = '1' AND servicecall.cid = contact.id  AND ".$owstr." AND contact.ownerid = employee.id  AND  contact.createdate BETWEEN '$fromdate' AND '$todate'",$con) or die(mysql_error());
$count6 = mysql_num_rows($getFtGiven);
$getServicecall = mysql_query("SELECT servicecall.id FROM servicecall,employee,contact WHERE servicecall.type = 'c' AND servicecall.cid = contact.id  AND ".$owstr." AND contact.ownerid = employee.id  AND  contact.createdate BETWEEN '$fromdate' AND '$todate'",$con) or die(mysql_error());
$count7 = mysql_num_rows($getServicecall);
$getScGiven = mysql_query("SELECT servicecall.id FROM servicecall,employee,contact WHERE  servicecall.type = 'c' AND servicecall.approved = '1' AND servicecall.cid = contact.id  AND ".$owstr." AND contact.ownerid = employee.id  AND  contact.createdate BETWEEN '$fromdate' AND '$todate'",$con) or die(mysql_error());
$count8 = mysql_num_rows($getScGiven);
$total = mysql_query("SELECT SUM(invoice.grandtotal) FROM invoice,employee,contact WHERE invoice.approved = '1' AND invoice.cid = contact.id AND contact.ownerid = employee.id AND  ".$owstr."  AND  contact.createdate BETWEEN '$fromdate' AND '$todate'",$con) or die(mysql_error());
