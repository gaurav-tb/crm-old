...
<tr>
	...
	<td style="">
	<input id="from0" name="fromdate" class="inputCalender"  onclick="openCalendar(this);" readonly="readonly" type="text">
	</td>
	<td align="right" style="; width: 202px; font-size:12px; height: 36px;">
	To Date
	</td>
	<td align="left">
	<input id="from0" name="todate" class="inputCalender"  onclick="openCalendar(this);" readonly="readonly" type="text">
	</td>
</tr>
<tr>
