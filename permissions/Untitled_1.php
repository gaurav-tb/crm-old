<table cellpadding="5" cellspacing="0" class="fetch" width="100%">
			<tr>
				<td align="right" rowspan="5" valign="top"><strong> <input name="Checkbox1" type="checkbox" checked="checked" id="leadAc" style="vertical-align:middle;margin-bottom:7px;" onchange="chkModule(\'lds\',\'leadAc\',\'16\',\'0\',\'\')" />Leads</strong></td>
			...
			<tr>
				<td align="right" rowspan="5" valign="top"><strong> <input name="Checkbox1" type="checkbox" checked="checked" id="contactAc" style="vertical-align:middle;margin-bottom:7px;" onchange="chkModule(\'lds\',\'contactAc\',\'34\',\'17\',\'\')" />Clients</strong></td>
			...
			<tr>
				<td align="right" rowspan="1" valign="top"><strong> <input name="Checkbox1" type="checkbox" checked="checked" id="reportAc" style="vertical-align:middle;margin-bottom:7px;" onchange="chkModule(\'lds\',\'reportAc\',\'37\',\'35\',\'\')" />Reports</strong></td>
			...
			<tr>
				<td align="right" rowspan="2" valign="top"><strong> <input name="Checkbox1" type="checkbox" checked="checked" id="masterAc" style="vertical-align:middle;margin-bottom:7px;" onchange="chkModule(\'lds\',\'masterAc\',\'44\',\'38\',\'\')" />Masters</strong></td>
