...
?>			
	...
	<!--	<td><input name="Checkbox1" type="checkbox"   style="vertical-align:middle;margin-bottom:7px;"  id="lds166" value="week_targetAVP"  <?php // if(in_array("week_targetAVP",$permissions)) echo "checked='checked'";?> />TL Week Target</td> -->
		...
		<tr>
		<td></td>
			<td><input name="Button1" type="button" value="Save Changes" class="buttonGreen" onclick="SaveData('permissions/save?profile=<?php echo $profile;?>','lds','196','','','','3');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')" />
			</td>
		</tr>
