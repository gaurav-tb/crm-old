...
{
?>
<input name="Button1" type="button" value="< Back To List" class="button" onclick="getModule('masters/category/view','viewContent','manipulateContent','Service Categories')" />
<?php
}
else
{
...
<tr>
<td align="right">Service Category Name<span style="color:maroon">*</span></td><td align="left">
...
<td></td>
<td>
<input name="Button2" type="button" value="Save & New" class="buttonGreen" onclick="SaveData('masters/category/save','opt','2','','','','1')" />&nbsp;&nbsp;
<input name="Button1" type="button" value="Save & Back" class="buttonGreen" onclick="SaveData('masters/category/save','opt','2','','','','1');ToggleBox('manipulateContent','none','');ToggleBox('viewContent','block','')" />&nbsp;&nbsp;
