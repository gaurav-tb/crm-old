...
<?php  if(in_array('U_service',$thisPer))
			{
			?>
<input name="Button1" type="button" value="Update" class="button" onclick="SaveData('masters/category/update?id=<?php echo $id;?>&i=<?php echo $_GET['i'];?>','opt','2','<?php echo $_GET['i'];?>','','','2')" />&nbsp;&nbsp;<?php } ?>
